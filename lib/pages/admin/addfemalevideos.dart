...
class AddFemaleVideos extends StatelessWidget {

  AddFemaleVideos({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return BlocConsumer<cubit, States>(builder: (context, state) {
        ...
        body: SafeArea(
          child: SizedBox(
            ...
            child: Stack(
              ...
              children: [
                backgroundImage(context, image: "lib/assets/images/gemy8.jpg"),
                    ...
                    child: Form(
                      ...
                      child: Column(
                        children: [
                          ...
                          ConditionalBuilder(
                              condition: state is! LoadingCreateFemaleVideos,
                              builder: (context) => button(
                                  ...
                                  function: () {
                                    if (formKey.currentState!.validate()) {
                                      cubit.get(context).createFemaleVideos(
      ...
      if (state is SuccessfullyCreateFemaleVideos) {

        Fluttertoast.showToast(
            msg: "video added successfully", backgroundColor: Colors.green);
      } else if (state is ErrorCreateFemaleVideos) {
        Fluttertoast.showToast(
